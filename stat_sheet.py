...
def create_player_buttons(new_window, team, stat, points):
    ...
    #Determines team amd creates buttons for players
    if team == "left":
        player_list = Left_team_player_list
    else:
        player_list = Right_team_player_list

    #Creates 5 buttons for each player
    for i in range(num_of_players):
        #i=i ensures correct binding for each button
